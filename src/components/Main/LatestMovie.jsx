...
const LatestMovies = () => {
  ...
  return (
    ...
    <div className="max-w-[1280px] mx-auto p-3">
      ...
      <div className="flex flex-wrap gap-10 mx-auto justify-center m-1 mb-4">
        {filterFilms.map((film, index) => (
          <div key={index} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 max-w-[200px] overflow-hidden shadow-lg bg-white relative mt-4 transition-transform duration-200 hover:scale-105">
            ...
            <img
              src={film.medium_cover_image || "https://images.pexels.com/photos/3131971/pexels-photo-3131971.jpeg?auto=compress&cs=tinysrgb&w=600"}
              alt={film.title}
